...
const cards = [
    ...
    },
    {
        ...
        date: "Apr 28, 2025",
        link: "https://www.dnaindia.com/brand-desk/report-what-to-do-if-matching-score-is-low-3146023#google_vignette",
        cta: "Watch Segment",
    },
    {
    ...
    },
    {
        ...
        date: "Nov 24, 2025",
        link: "https://www.mid-day.com/buzzfeed/article/how-to-check-qualities-of-a-good-astrologer-for-accurate-predictions",
        cta: "Read Article",
    },
    {
        publication: "Zee News",
    ...
    },
    {
        ...
        date: "May 01, 2025",
        link: "https://www.outlookindia.com/announcements/news-media-wire/sushant-sinha-interviews-dr-vinay-bajrangi",
        cta: "Read Article",
    },
    {
        ...
        date: "May 11, 2018",
        link: "https://www.hindustantimes.com/advertorial/what-everybody-ought-to-know-about-running-a-business-astrologically-dr-vinay-bajrangi/story-I7zgX4xRoBiIglNuRwSbbO.html",
        cta: "Read Article",
    },
    {
        ...
        date: "Nov 11, 2025",
        link: "https://www.issuewire.com/dr-vinay-bajrangi-expands-online-astrology-consultation-services-worldwide-1848040238415974",
        cta: "Read Article",
    },
];
        ...
        <>
            ...
            <section className="relative overflow-hidden bg-[var(--ink)] px-6 pt-[100px] pb-20 text-center md:px-6">
                ...
                <div className="relative z-10">
                    ...
                    {/* Heading */}
                    <h1 className="mb-6 font-[var(--font-display)] text-[clamp(42px,7vw,78px)] font-semibold leading-[1.1] text-[var(--cream)]">
                    ...
                    {/* Subtext */}
                    <p className="mx-auto mb-11 max-w-[680px] text-base font-light leading-[1.8] text-[rgba(253,246,236,0.75)]">
            ...
            <section className="bg-[linear-gradient(135deg,var(--saffron)_0%,var(--gold)_100%)] px-6 py-8">
                <div className="mx-auto grid max-w-[960px] grid-cols-[repeat(auto-fit,minmax(160px,1fr))] gap-6 text-center">
                    {stats.map((stat, index) => (
                        <div key={index}>
                            <div className="font-[var(--font-display)] text-[44px] font-bold leading-none text-[var(--white)]">
                                {stat.number}
                            </div>
            ...
            <section className="border-y border-[var(--divider)] bg-[var(--cream-deep)] px-6 py-14 text-center">
                {/* Label */}
                <p className="mb-9 text-[11px] font-semibold uppercase tracking-[0.22em] text-[var(--ink-soft)]">
                    As Seen &amp; Quoted In
                </p>
                ...
                <div className="flex flex-wrap items-center justify-center gap-0">
                    {publications.map((publication, index) => (
                        ...
                        >
                            <span className="whitespace-nowrap font-[var(--font-display)] text-[17px] font-bold tracking-[0.02em] text-[var(--ink-mid)]">
                                {publication}
                            </span>
                        </div>
                    ))}
                ...
                {/* Notice */}
                <div className="mt-8 flex items-center justify-center gap-3 rounded border border-dashed border-[var(--divider)] px-6 py-5 text-[13px] text-[var(--ink-soft)]">
                    <svg
                    ...
                    <span>
                        Additional publication logos will be added as media links are verified and confirmed by the
                        team.
                    </span>
                </div>
            </section>
            ...
            <section className="bg-[var(--cream)] px-6 py-20">
                <div className="mx-auto max-w-[1100px]">
                    {/* Section Header */}
                    <p className="mb-[10px] text-[11px] font-semibold uppercase tracking-[0.22em] text-[var(--saffron)]">
                        Highlighted Features
                    </p>

                    <h2 className="mb-4 font-[var(--font-display)] text-[clamp(30px,4vw,48px)] font-semibold leading-[1.2] text-[var(--ink)]">
                        Featured Coverage
                    </h2>

                    <p className="mb-12 max-w-[560px] text-[15px] leading-[1.8] text-[var(--ink-mid)]">
                        Select articles where Dr. Bajrangi has authored expert columns, been quoted as a Vedic astrology
                        authority, or been profiled by a leading publication.
                    </p>
                        ...
                        {cards.map((card, i) => (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between border-b border-[var(--cream-deep)] px-6 pb-4 pt-6">
                                    <span className="font-[var(--font-display)] text-lg font-bold text-[var(--ink)]">
                                        {card.publication}
                                    </span>

                                    <span
                                        className={`rounded-[20px] px-[10px] py-1 text-[9px] font-semibold uppercase tracking-[0.15em] whitespace-nowrap ${badgeStyles[card.badgeType]}`}
                                    >
                                        {card.badge}
                                    </span>
                                </div>
                                ...
                                <div className="flex-1 px-6 py-5">
                                    <h3 className="mb-[10px] font-[var(--font-display)] text-[19px] font-semibold leading-[1.35] text-[var(--ink)]">
                                        {card.title}
                                    </h3>

                                    <p className="text-[13.5px] leading-[1.7] text-[var(--ink-soft)]">{card.summary}</p>
                                </div>

                                {/* Footer */}
                                <div className="flex items-center justify-between border-t border-[var(--cream-deep)] px-6 py-4">
                                    <span className="text-xs tracking-[0.05em] text-[var(--ink-soft)]">
                                        {card.date}
                                    </span>
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="flex items-center gap-[5px] text-xs font-semibold tracking-[0.08em] text-[var(--saffron)] transition-all hover:gap-2"
                                    >
                                        {card.cta}
                                        <svg
                                            className="h-3 w-3"
                    ...
                    {/* Notice */}
                    <div className="mt-8 flex items-center justify-center gap-3 rounded border border-dashed border-[var(--divider)] px-6 py-5 text-center text-[13px] text-[var(--ink-soft)]">
                        Featured coverage cards will be populated by the team as article links are verified.
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[var(--cream-deep)] px-6 py-20">
                <div className="mx-auto max-w-[1100px]">
                    ...
                    <p className="mb-12 max-w-[560px] text-[15px] leading-[1.8] text-[var(--ink-mid)]">
                        A comprehensive listing of all verified media appearances, expert quotes, and published articles
                        ...
                        <table className="w-full border-collapse text-sm">
                            <thead>
                                <tr className="border-b-2 border-[var(--divider)]">
                                    <th className="px-4 py-[14px] text-left text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--ink-soft)]">
                                        Publication
                                    </th>
                                    <th className="px-4 py-[14px] text-left text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--ink-soft)]">
                                        Headline / Topic
                                ...
                                {rows.map((row, i) => (
                                    ...
                                    >
                                        <td className="px-4 py-4">
                                            <span className="font-[var(--font-display)] text-base font-bold text-[var(--ink)]">
                                                {row.publication}
                                            </span>
                                        </td>

                                        <td className="px-4 py-4 text-[var(--ink)]">{row.headline}</td>

                                        <td className="px-4 py-4">
                                            <span
                                                className={`rounded px-2 py-1 text-[9px] font-semibold uppercase tracking-[0.12em] ${badgeStyles[row.typeClass]}`}
                                            >
                                                {row.type}
                                            </span>
                                        </td>
                                        ...
                                        <td className="px-4 py-4">
                                            <span
                                                className={`rounded px-2 py-1 text-[9px] font-semibold uppercase tracking-[0.12em] ${tierStyles[row.tierClass]}`}
                                            >
                                                {row.tier}
                                            </span>
                                        </td>

                                        <td className="px-4 py-4 text-[var(--ink-mid)]">{row.date}</td>
                                        ...
                                        <td className="px-4 py-4">
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className="inline-flex items-center gap-1 text-[13px] font-medium text-[var(--saffron)] hover:text-[var(--terracotta)]"
                                            >
                                                Visit
                                                <svg
                    ...
                    {/* Notice */}
                    <div className="mt-6 flex items-center justify-center gap-3 rounded border border-dashed border-[var(--divider)] px-6 py-5 text-center text-[13px] text-[var(--ink-soft)]">
                        New rows are added by the team as each article URL is confirmed live.
                    </div>

                    {/* Tier Guide */}
                    <div className="pt-10 text-center">
                        <p className="mt-5 text-xs leading-[1.8] text-[var(--ink-soft)]">
            ...
            <section className="relative overflow-hidden bg-[var(--ink)] px-6 py-20 text-center">
                ...
                <div className="relative mx-auto max-w-[1100px]">
                    <p className="mb-[10px] text-[11px] font-semibold uppercase tracking-[0.22em] text-[var(--gold-light)]">
                        For Journalists &amp; Producers
                    </p>

                    <h2 className="mx-auto mb-4 max-w-[600px] font-[var(--font-display)] text-[clamp(30px,4vw,48px)] font-semibold leading-[1.2] text-[var(--cream)]">
                        Media &amp; Press Enquiries
                    </h2>

                    <p className="mx-auto mb-10 max-w-[580px] text-[15px] leading-[1.8] text-[rgba(253,246,236,0.72)]">
                        Journalists, editors, and producers covering Vedic astrology, planetary transits, annual
                        predictions, marriage astrology, career guidance, or any related subject are welcome to reach
                        out to Dr. Vinay Bajrangi for expert commentary, quotes, or broadcast appearances.
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <a
                            ...
                            className="inline-flex items-center rounded-[2px] border border-[rgba(253,246,236,0.3)] px-8 py-[14px] text-[13px] font-semibold uppercase tracking-[0.1em] text-[var(--cream)] transition-all duration-300 hover:border-[rgba(253,246,236,0.6)] hover:bg-[rgba(253,246,236,0.07)]"
                        >
                            About Dr. Bajrangi
                        </a>
                    </div>
            ...
            <div className="border-t border-[var(--divider)] bg-[var(--cream-deep)] px-6 py-6 text-center text-xs text-[var(--ink-soft)]">
                All media coverage listed on this page is third-party editorial and has not been paid for or sponsored.
                Publication logos are used as reference only and remain the property of their respective owners. For
                link corrections or removal requests, please{" "}
